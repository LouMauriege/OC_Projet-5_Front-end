...
describe('ListComponent', () => {
  ...
  it('should display the edit button if user is admin', () => {
    const editButton = fixture.debugElement.queryAll(By.css('[data-testid="edit"]'));

    expect(editButton.length).toBe(2);
    expect(editButton[0].nativeElement.textContent).toContain('Edit');
  });
  ...
  it('should not displat the edit button if user is not admin', () => {
    mockSessionService.sessionInformation = { admin: false };
